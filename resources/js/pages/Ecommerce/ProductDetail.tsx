                    ...
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="w-full border-l p-6 lg:w-3/5">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="mb-4 flex items-center">
                                    <span className="text-3xl font-bold text-indigo-600">${computedProduct.price}</span>
                                    {computedProduct.variation && <span className="ml-2 text-sm text-gray-500">(Selected variation)</span>}
                                </div>
